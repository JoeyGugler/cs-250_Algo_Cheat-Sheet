...
\textbf{Runtime:} \timecomplexity{$\Theta((V + E) \log V)$} with binary heaps, \timecomplexity{$\Theta(E + V \log V)$} with Fibonacci heaps.
\endtcolorbox
...
\begin{itemize}
  ...
  \item \textbf{Search} \timecomplexity{$\bigo(N + E)$} (in worst-case)
